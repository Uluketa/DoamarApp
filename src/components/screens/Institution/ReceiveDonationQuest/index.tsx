    ...
    return (
        <View className='flex-1 items-center'>
            ...
            >
                ...
                <View className='w-60'>
                    <ButtonAvancar bgColor={colors.palette[3]} onPress={() => navigation.navigate("Layout")} title='Cadastrar Itens' />
                </View>
            </View>

            <View className='items-center justify-center h-1/5 w-40' >
                <ButtonAvancar bgColor='#a8a8a8' onPress={() => navigation.navigate("Layout")} title='Pular' />
            </View>
        </View>
    );
}
