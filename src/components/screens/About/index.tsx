...
export function About() {
    return (
        <View>
            ...
            <View className="w-full p-5" style={{ backgroundColor: colors.background }}>
                <View>
                    <Text className="font-bold text-2xl text-gray-800 mb-2" style={{ color: colors.text }}>Quem somos?</Text>
                    <Text style={{ textAlign: 'justify', color: colors.text }} className="text-gray-700 leading-7">
                    ...
                    <Text className="font-bold text-2xl text-gray-800 mt-6 mb-2" style={{ color: colors.text }}>Nosso objetivo</Text>
                    <Text style={{ textAlign: 'justify', color: colors.text }} className="text-gray-700 leading-7">
                    ...
                    <Text className="font-bold text-2xl text-gray-800 mt-6 mb-2" style={{ color: colors.text }}>Fonte de inspiração</Text>
                    <Text style={{ textAlign: 'justify', color: colors.text }} className="text-gray-700 leading-7">
